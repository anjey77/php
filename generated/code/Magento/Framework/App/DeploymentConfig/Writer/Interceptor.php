...
class Interceptor extends \Magento\Framework\App\DeploymentConfig\Writer implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function checkIfWritable()
    {
        ...
        if (!$pluginInfo) {
            return parent::checkIfWritable();
        } else {
            return $this->___callPlugins('checkIfWritable', func_get_args(), $pluginInfo);
        }
    }
     ...
     * {@inheritdoc}
     */
    public function saveConfig(array $data, $override = false, $pool = null, array $comments = array())
    {
