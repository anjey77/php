...
class Email extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function sendInvoiceFailed($subscription){
        $templateVendorId = $this->scopeConfig->getValue(Config::INVOICE_FAILED_VENDOR_TEMPLATE) ?: 'omnyfy_subscription_general_invoice_vendor_failed';
        $this->sendEmail($subscription, $templateVendorId);
        $templateAdminId = $this->scopeConfig->getValue(Config::INVOICE_FAILED_ADMIN_TEMPLATE) ?: 'omnyfy_subscription_general_invoice_mo_failed';
