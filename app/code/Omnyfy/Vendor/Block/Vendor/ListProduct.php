...
class ListProduct extends \Magento\Catalog\Block\Product\ListProduct
{
    ...
    protected function _getProductCollection()
    {
        ...
        $defaultProductPerPageGrid = $this->scopeConfig->getValue('catalog/frontend/grid_per_page', $storeScope);
        $defaultProductPerPageList = $this->scopeConfig->getValue('catalog/frontend/list_per_page', $storeScope);

        if ($this->getRequest()->getParam('product_list_mode') == 'list') {
            $pageSize = ($this->getRequest()->getParam('product_list_limit'))? $this->getRequest()->getParam('product_list_limit') : $defaultProductPerPageList;
        }
        else {
            $pageSize = ($this->getRequest()->getParam('product_list_limit'))? $this->getRequest()->getParam('product_list_limit') : $defaultProductPerPageGrid;
        }

        $productListOrder = ($this->getRequest()->getParam('product_list_order'))? $this->getRequest()->getParam('product_list_order') : 'position';
        ...
        $this->_productCollection->setOrder($productListOrder, $productListDir);
