...
class Form extends \Magento\Framework\View\Element\Template
{
    ...
    function getRatingLabel($rating){
        if ($rating->getVendorRatingCodes()){
            $storeId = $this->_storeManager->getStore()->getId();
            $ratingCodes = $this->serializer->unserialize($rating->getVendorRatingCodes());
            return $ratingCodes[$storeId];
        }
        return $rating->getVendorRatingCode();
    }
