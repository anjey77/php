...
namespace Omnyfy\Cms\Block\Adminhtml\Import\Wordpress;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
         ...
         */
        if ($this->_authorization->isAllowed('Omnyfy_Cms::import')) {
        ...
        $fieldset->addField(
            ...
            [
                'label' => __('NOTICE'),
                'name' => 'prefix',
                'after_element_html' => 'When the import is completed successfully, please copy image files from WordPress <strong style="color:#bd1616;">wp-content/uploads</strong> directory to Magento <strong style="color:#105610;">pub/media/omnyfy_cms</strong> directory.',
            ]
        );
        ...
        $this->_eventManager->dispatch('omnyfy_cms_import_wordpress_prepare_form', ['form' => $form]);
