 ...
 */
class ArticleList extends \Omnyfy\Cms\Block\Article\ArticleList\AbstractList
{
    /**
     * Block template file
     * @var string
     */
    protected $_defaultToolbarBlock = 'Omnyfy\Cms\Block\Article\ArticleList\Toolbar';
    ...
    protected function _prepareLayout()
    {
        $page = $this->_request->getParam(
            \Omnyfy\Cms\Block\Article\ArticleList\Toolbar::PAGE_PARM_NAME
        );
     ...
     * @return \Omnyfy\Cms\Block\Article\ArticleList\Toolbar
     */
